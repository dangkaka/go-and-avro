...
func readDemoSchema2(r io.Reader) (*DemoSchema2, error) {
	var str = &DemoSchema2{}
	var err error
	str.IntField, err = readInt(r)
	if err != nil {
...
func writeActivity(r *Activity, w io.Writer) error {
	var err error
...
func writeDemoSchema2(r *DemoSchema2, w io.Writer) error {
	var err error
	err = writeInt(r.IntField, w)
	if err != nil {
		return err
